package com.example.funtimedatabase
    ...
    private fun showUpdateDialog(user: Users) {
        ...
        builder.setPositiveButton("Update"){dialogInterface, i ->
            ...
            when{
                ...
                nama.isEmpty() -> {
                    view.et_nama_update.error = "Nama Tidak Boleh Kosong JHON!!!"
                    return@setPositiveButton
                }

                email.isEmpty() -> {
                    view.et_email_update.error = "Email Tidak Boleh Kosong JHON!!!"
                    return@setPositiveButton
                }

                else -> {
                    val iser = Users(user.id, nama, email)
